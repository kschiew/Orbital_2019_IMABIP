...
public class BookingObject implements Serializable {
    private String Name, Sport, Date, Hour, Venue, Unit;
    ...
    public BookingObject(String sport, String date, String hour, String venue, String unit) {
        Sport = sport;
        Date = date;
        Hour = hour;
        Venue = venue;
        Unit = unit;
        Name = Unit + Venue + Date + Hour;
    }
    ...
    public void newEntry() {
        ...
        fs.collection(bookingsCollection).document(Name).set(map);
    }
